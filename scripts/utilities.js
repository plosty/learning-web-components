...
console.log(utilities.keys(testObj)); // ["var1", "var2", "var3"]
...
console.log(utilities.values({count: 5, length: 10, total: 16})); // will output: [5, 10, 16])
...
console.log(utilities.pairs(testObj)); // ["var1", "test1", "var2", "test2", "var3", "test3"]
...
console.log(utilities.shuffle(arr)); // will output something like: [20,40,50,30,10]
...
console.log(utilities.pluralize(1, "lion"));     // returns "lion"
console.log(utilities.pluralize(2, "lion"));     // returns "lions"
console.log(utilities.pluralize(5, "lion"));     // returns "lions"
console.log(utilities.pluralize(0, "lion"));     // returns "lions"
console.log(utilities.pluralize(1, "lioness"));  // returns "lioness"
console.log(utilities.pluralize(2, "lioness"));  // returns "lionesss"
console.log(utilities.pluralize(2, "lioness", "lionesses")); // "lionesses"
...
console.log(utilities.toDash("hotDog"));              // returns "hot-dog"
console.log(utilities.toDash("spaceStationComplex")); // returns "space-station-complex"
console.log(utilities.toDash("myFirstFunction"));     // returns "my-first-function"
...
console.log(utilities.toCamelCase("hot-dog"));              // returns "hotDog"
console.log(utilities.toCamelCase("space-station-complex")); // returns "spaceStationComplex"
console.log(utilities.toCamelCase("my-first-function"));     // returns "myFirstFunction"
...
console.log(utilities.has(car, "Fiat")); // returns true
console.log(utilities.has(car, "blue")); // returns false
...
console.log(utilities.withoutSymbols('I a$m not rea@ll&^y s*u[r]e# abou!t t<h>is o?n|e')); // returns 'I am not really sure about this one'
...
console.log(utilities.countWords("Hello.")); // returns 1
console.log(utilities.countWords("Hard-to-type-really-fast!")); // returns 5
console.log(utilities.countWords("Hard-to-type-really-fast")); // returns 5
console.log(utilities.countWords("")); // returns 0
console.log(utilities.countWords("supercalifragilisticexpialidocious")); // returns 1
